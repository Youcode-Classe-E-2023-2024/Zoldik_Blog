    ...
    <div class="flex">
        ...
        <aside class="h-screen from-sky-950 text-white bg-gradient-to-b bg-sky-800 fixed" style="width: 20%;">
            <div class="flex mb-10 bg-emerald-500 bg-gradient-to-l from-cyan-900">
                <img src="../<?= $objUser['avatar']; ?>" class="my-2 h-16 rounded-r-xl hover:opacity-80" alt="">
            ...
            <div class="opacity-80 bg-none" id="l">
                ...
                <p class="w-full p-4 pl-10 my-2 text-2xl hover:cursor-pointer opacity-70">Articles</p>
                <div class="my-4">
                    <a href="add-post.php" class="w-full p-4 pl-10 my-2 text-2xl hover:cursor-pointer opacity-70">Add Article</a>
                <div class="my-8">
                    <a href="add-category.php" class="w-full p-4 pl-10 my-2 text-2xl hover:cursor-pointer opacity-70">Add Category</a>
                </div>
                <div class="my-8">
