...
<body class="bg-gray-100 font-sans">
   <article id="ENCAPSULATER">
      ...
      <article class="grid grid-cols-6">
         <!-- categories section -->
         <main id="categoriesSct" class="col-span-1 pt-2 px-2">
         ...
         <main class="col-span-5 h-screen overflow-auto">
            ...
            <section id="index2global">
               ...
               <!-- child2 -->
               <section>
                  <a id="top_bloggers_btn" class=" bg-red-500 cursor-pointer flex items-center p-2 rounded-md">
                     <strong>Top bloggers</strong>
                     <ion-icon name="chevron-forward-outline" class="text-2xl cursor-pointer"></ion-icon>
                  </a>
                  <main id="top_bloggers_sct" class="HIDDEN bg-green-500 p-2">
                           ...
                           foreach($articles as $article) {
                              if($article[6] == $value) {
                                 foreach($users as $user) {
                                    if ($user[0] == $value) {
                                       $html .=<<<HEREDOC
                                          <div class="flex justify-between items-center border-b border-solid border-black p-2">
                                             <div class="flex items-center gap-2">
                                                <div class="w-14 h-14 rounded-full" style="background-image:url('../images/{$user[6]}');background-size: cover;"></div>
                                                <div>{$user[3]}</div>
                                                </div>
